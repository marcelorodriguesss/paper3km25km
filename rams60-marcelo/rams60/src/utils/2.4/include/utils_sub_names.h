...
#define par_put_float8 par_put_float8_
...
#define par_get_float8 par_get_float8_
#define par_get_char par_get_char_
#define par_put_log par_put_log_
#define par_get_log par_get_log_
