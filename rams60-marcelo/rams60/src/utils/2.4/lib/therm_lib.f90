...
real function rs(p,t) ! p in Pa, T in K
implicit none
real :: p,t,es
...
! This formulation seems to be most similar to: 
! Buck Research Manual (1996)
! updated equation from 
! Buck, A. L., New equations for computing vapor pressure and 
! enhancement factor, J. Appl. Meteorol., 20, 1527-1532, 1981

! es = 6.1121  e(17.502*t / (240.97 + t) ) (1981)
! es = 6.1121  e( (18.678 - t / 234.5) t ) / (257.14 + t) ) (1996)

! or maybe Bolton(1980)
! es = 6.112   e(17.67 * t / (t+243.5) )

! Maybe someday someone will see if there is a difference...
