...
integer :: nvbtab
   ...
   ! Info from last variable read
   integer :: vclass, vgrid, vnvals
...
subroutine an_setvar_info(class, name, grid, nvals)

implicit none

integer, optional :: class, grid, nvals
character(len=*), optional :: name

if (present(class))  vclass = class
if (present(name))   vname  = name
if (present(grid))   vgrid  = grid
if (present(nvals))  vnvals = nvals

return
end subroutine

subroutine an_getvar_info(class, name, grid, nvals)
...
if (present(class)) class = vclass
if (present(name))  name  = vname
if (present(grid))  grid  = vgrid
if (present(nvals)) nvals = vnvals
