...
100 format(a1,a,a1,i4.4,a1,i2.2,a1,i2.2,a1,i6.6)
...
subroutine makefnam8 (fname,prefix,tinc,iyr,imn,idy,itm,type,post,fmt)
...
if(tinc == 0.) then
   ...
   call date_add_to8(iyr,imn,idy,itm,tinc,'s',oyr,omn,ody,otm)
!   print*,oyr,omn,ody,otm
endif
