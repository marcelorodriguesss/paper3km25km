...
int parse_1st_msg(unsigned char **sec) {
	...
	fprintf(stderr, "p %d sec0 %d sec1 %d sec2 %d sec3 %d sec4 %d sec5 %d sec6 %d sec7 %d sec8 %d\n",
		p-Sec[0], Sec[0]-Sec[0], Sec[1]-Sec[0], Sec[2]-Sec[0], Sec[3]-Sec[0], 
		Sec[4]-Sec[0], Sec[5]-Sec[0], Sec[6]-Sec[0], Sec[7]-Sec[0], Sec[8]-Sec[0]);
