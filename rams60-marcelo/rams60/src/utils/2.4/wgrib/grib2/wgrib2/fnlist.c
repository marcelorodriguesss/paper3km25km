...
struct function functions[] = {
   ...
   {"if",f_if, misc, 1, "process data that matchs X (regular expression)", 100},
   {"no_header",f_no_header, misc, 0, "no f77 header or nx-ny header in text output", 100},
   {"one_line",f_one_line, misc, 0, "puts all on one line", 100},
   ...
   {"nc_pack",f_nc_pack, setup, 1, "pack all NEW input variables, X=min:max:[byte|short], default no packing", 100},
