...
!    of the zenith angle is greater than .03 .
      ...
      if (cosz(i,j) .gt. .03) then
         ...
         elseif (iswrtyp .eq. 1) then
            call shradc(nzp+1,rvr,rtr,dn0r,dztr,prd,vctr1  &
...
do j = ja,jz
   do i = ia,iz
      ...
      call radcalc3(m1,maxnzp,mcat,iswrtyp,ilwrtyp,if_adap,lpw  &
...
integer i,j,k,ib,ig,kk,ik,koff,nradmax
integer, save :: ncall = 0
