...
real :: colddn0,rolddn0,qrolddn0,dispemb,riemb,wt2,psfc,qpcpg,pcpg,dpcpg  &
   ,dtlti,qnew,alphasfc
real, dimension(m1) :: rtp,thp,theta,dn0,cnew,rnew,qrnew,dzt
