...
integer :: m1,m2,m3,ia,iz,ja,jz,jd,ia_1,ja_1,ia1,ja1,iz_1,jz_1,iz1,jz1  &
   ,izu,jzv,idiffkk,ibcon,mynum,i,j,k
...
real, dimension(m2,m3) :: ci2i
real, dimension(m1,m2,m3) :: cim1,rhs,cjp1,cji,out
...
implicit none
integer :: m1,m2,m3,ia,iz,ja,jz,jd,ngrid,nz,jaa,jzz,nclip,je,jf,i,j,k

real :: delz1,delz3,distnu,distold,scale,aknu,akdiff,dtl
real, dimension(m1,m2,m3) :: vc3da,vc3db,dn0hkh,dn0
...
implicit none
integer :: m1,m2,m3,i,j,ipm1,jpm1,jd,ip,jp,ij,k

real :: dxy,tanth,pct,delz1,delz2,delz3,vc1,vc3,vc2
real, dimension(m1,m2,m3) :: vc3da
real, dimension(m1) :: vctr1,vctr2,zint,dxynu,z,vctr3
