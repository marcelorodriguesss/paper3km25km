...
! modification for vertical or overhanging slopes or for resolved canopy flow.
      ...
      vt3dj(ka,i,j) = 0.
      vt3dk(m1-1,i,j) = 0.
      if (nstbot == 1) vt3do(ka,i,j) = dn0u(ka,i,j) - vt3dk(ka,i,j)
...
! modification for vertical or overhanging slopes or for resolved canopy flow.
      ...
      vt3dj(ka,i,j) = 0.
      vt3dk(m1-1,i,j) = 0.
      if (nstbot == 1) vt3do(ka,i,j) = dn0v(ka,i,j) - vt3dk(ka,i,j)
