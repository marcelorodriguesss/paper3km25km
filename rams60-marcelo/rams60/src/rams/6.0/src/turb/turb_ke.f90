...
integer :: m1,m2,m3,m4,ia,iz,ja,jz
real, dimension(m1,m2,m3) :: tkep,tket,epsp,epst  &
          ,vt3da,vt3dc,vt3dh,vt3di,vt3dj,scr1,scr2  &
          ,vt3dd,vt3de,dn0
real, dimension(m2,m3) ::  rtgt,dxt
real, dimension(m2,m3,m4) ::  ustar,patch_area
...
integer :: m1,m2,m3,m4,ia,iz,ja,jz
real, dimension(m1,m2,m3) :: tkep,tket,epsp,epst  &
          ,vt3da,vt3dc,vt3dh,vt3di,vt3dj,scr1,scr2,dn0
...
integer :: m1,m2,m3,ia,iz,ja,jz,ibcon,jd
real, dimension(m1,m2,m3) :: tkep,tket,up,vp,wp,rtp,rv,theta  &
   ,vt3da,vt3dc,vt3dh,vt3dj,scr1,scr2
real, dimension(m2,m3) :: dxt,sflux_u,sflux_v,sflux_w,sflux_t,rtgt
integer, dimension(m2,m3) :: lpw
...
implicit none
integer :: m1,m2,m3,ia,iz,ja,jz,ibcon,jd,i0,j0
...
integer, dimension(m2,m3) :: lpw,lpu,lpv
