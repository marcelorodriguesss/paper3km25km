...
subroutine acoust_adap(m1,m2,m3,lpu,lpv,lpw            &
...
if (distim .ne. 0.) then
   call rayf_adap(2,m1,m2,m3,ia,iz,ja,jz,ibcon,lpv(1,1),vp,th0,vt3dh)
endif
...
if (distim .ne. 0.) then
   call rayf_adap(3,m1,m2,m3,ia,iz,ja,jz,ibcon,lpw(1,1),wp,vt3dh,vt3dh)
endif
