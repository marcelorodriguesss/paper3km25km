...
!print*,'ll_p-----0: ',p_t(1:144,54,2)
!do k=1,nprz
!do j=1,npry
!   do i=1,nprx
!   p_t(i,j,k) = p_t(i,54,k)
!enddo
!enddo
!enddo
!print*,'ll_p%%%%%%%: ',nprx,npry,nprz
!print*,'ll_p-----1: ',p_t(1:144,52,2)
!print*,'ll_p-----1: ',p_t(1:144,53,2)
!print*,'ll_p-----1: ',p_t(1:144,54,2)
!print*,'ll_p-----1: ',p_t(130,1:73,2)
...
!print*,'ps_p%%%%%%%: ',nnxp(ngrid),nnyp(ngrid)
!!print*,'%%%%%%%: ',pp_t(1:94,50,3)
!print*,'ps_p%%%%%%%: ',pp_t(1:94,50,2)
!!print*,'%%%%%%%: ',pp_t(1:94,50,1)
!stop        
...
! If guess1st == RAMS, we will not do the isentropic analysis. 
