...
character(len=256) :: line,line2,fnameu
...
integer :: nobs,k,ierr,ifile,nnn
integer :: ntok,jt,lp,lz,i,j,jyr,jmo,jdy,kl,iqf,iq
real :: xlat,xlon,elev
...
character(len=1) :: itflg
character(len=4) :: iddd
character(len=8) :: idsta
character(len=256) :: line,line2, fnameu
character(len=64) :: cflags
character(len=32) :: tokens(40),var_string
integer :: iqflags(max_sfc_vars,3),iqfl(max_sfc_vars)
real*8 nasecs
